...
class CategoryController extends Controller
{
    ...
    public function modifiercategorie(Request $request, $id){
        ...
        $categorie->update();
        return redirect('/categories')->with('status','La catégorie ' .
        $categorie->category_name . ' a été modifiéé avec succès');
    }
    ...
    public function supprimercategorie($id){
        ...
        return redirect('/categories')->with('status','La catégorie ' .
        $categorie->category_name . ' a été supprimé avec succès');
    }
}
