		  ...
		  <div class="row justify-content-center">
			  <div class="col-md-10 mb-5 text-center">
				  <ul class="product-category">
					  ...
					  <li><a href="{{url('/select_par_cat',[$categorie->category_name])}}" class="{{request()->
					  	is('select_par_cat/'.$categorie->category_name)?'active':''}}">{{$categorie->category_name}}</a></li>
					  @endforeach
				  </ul>
			  </div>
		  </div>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="product">
						...
						<div class="text py-3 pb-4 px-3 text-center">
							...
							<div class="d-flex">
								<div class="pricing">
									<p class="price"><span class="price-sale">${{$produit->product_name}}</span></p>
								</div>
							</div>
